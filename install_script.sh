...
if [ $OS == "MAC" ]; then
...
elif [ "$DISTRO" == "MANJAROLINUX" ]; then
    {
        ...
        sudo pacman -Syu tmux feh rofi shellcheck python-pip zsh zsh-completions go postgresql mariadb compton xorg-xbacklight hub redis powerline powerline-fonts xorg-xmodmap geary neofetch keepassxc deepin-terminal
